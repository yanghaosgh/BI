...
public class DataUtils {
	...
	public static final String[] attrs_l = { "b_post", "banner_id", "brand_id", "business_id", "cate_id", "designer_id", "detail_id", "duration", "eventname", //
			...
			"topic_id", "ts", "tuan_id", "prefecture_id", "type", "type_id", "waittime", "ad_post", "favor_type", "user_type", "show_detail_id", "utm_source", //
			"flashsales_title", "flashsales_time", "tab_id", "cdate" };
	...
	public static final String[] attrs_all = { "gv", "gf", "gc", "access_token", "uid", "push_token", "gi", "os", "gos", "gs", "net", "isp", "ts", "duration", "gt", "appkey", "member_level", //
			...
			"tab_4", "thread_id", "topic_id", "tuan_id", "prefecture_id", "type", "type_id", "waittime", "ad_post", "favor_type", "user_type", "show_detail_id", "utm_source", //
			"flashsales_title", "flashsales_time", "tab_id", "cdate" };

	public static final String[] attrs_paid_all = { "user_id", "source_id", "goods_id", "order_id", "pay_order_id", "pay_count", "pay_price", //
			"pay_amount", "ts", "title", "url_img", "banner_id", "thread_id", "topic_id", "tuan_id", "prefecture_id", "brand_id", "business_id", "cate_id", "designer_id", "detail_id", "source", //
			"tab_1", "tab_2", "tab_3", "tab_4", "bannder_duration", "utm_source", "position", "tab_id" };
